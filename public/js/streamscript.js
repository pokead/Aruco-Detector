...
streamBtn.addEventListener('click', async () => {
  ...
  console.log("http://127.0.0.1:8000/stream/?link=" + encodedStreamUrl + "&" + "replace=" +  encodeURIComponent(replace))
  //document.getElementById('input').src = stream
  //console.log('/api/streaming?stream=' + encodedStreamUrl)
  //console.log(data)
  document.getElementById('result').src = "http://127.0.0.1:8000/stream/?link=" + encodedStreamUrl + "&" + "replace=" +  encodeURIComponent(replace)
